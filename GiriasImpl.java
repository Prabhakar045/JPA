package com.Xworkz.GiriasApplication.impl;

import com.Xworkz.GiriasApplication.GiriasApp.Girias;
...
public class GiriasImpl implements Girias {
    ...
    public ProductDTO getProductInfoId(int id) {
        return new Persistence().createEntityManagerFactory("com.pk").createEntityManager().find(ProductDTO.class, 1);
